...
const services: Service[] = [
  { id: 1, name: "Digital PR", href: "#", image: "/work-images/work-1.jpg" },
  { id: 2, name: "Organic Social & Content", href: "#", image: "/work-images/work-2.jpg" },
  { id: 3, name: "Search & Growth Strategy", href: "#", image: "/work-images/work-4.jpg" },
  { id: 4, name: "Content Experience", href: "#", image: "/work-images/work-3.jpg" },
  { id: 5, name: "Data & Insights", href: "#", image: "/work-images/work-1.jpg" },
  { id: 6, name: "Onsite SEO", href: "#", image: "/work-images/work-2.jpg" },
];
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="flex flex-col md:flex-row justify-between items-center gap-8 mb-8">
              ...
              <span className="inline-flex items-center">
                <span className="inline-block w-12 h-12 md:w-16 md:h-16 lg:w-18 lg:h-18 rounded-lg overflow-hidden mx-3">
                  <div
                    ...
                    style={{ backgroundImage: "url('/services/header.webp')" }}
                  />
                </span>
                Services
              </span>
          ...
          <div className="hidden w-full md:w-[1/3] md:flex items-center justify-start md:justify-end">
            <PrimaryButton lable="View All Services" url="/services/" />
          </div>
        </div>

        {/* Divider */}
        <div className="w-full h-px bg-grey-400 mb-0 hidden md:block" />
          ...
          {services.map((service, index) => (
            ...
            >
              ...
              {index < services.length - 2 && (
                <div className="absolute bottom-0 left-0 right-0 h-px bg-grey-400" />
              )}
              ...
              <div className="relative z-10 flex items-center gap-3">
                ...
                {/* Service Name */}
                <span
                  className={`text-lg md:text-[40px] font-medium transition-colors duration-300 ${hoveredId === service.id ? "text-white" : "text-grey-900 whitespace-nowrap"
                    }`}
                >
                  {service.name}
                </span>
